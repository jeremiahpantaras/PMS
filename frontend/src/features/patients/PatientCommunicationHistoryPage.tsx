...
function InlineThread({ log }: { log: CommunicationLogEntry }) {
  ...
  return (
    <div className="px-4 pb-4 bg-gray-50/60 border-b border-gray-100">
      <div className="ml-11 space-y-4">

        {/* Outbound message */}
        <div>
          <div className="flex items-center gap-2 mb-2">
            <div className="w-5 h-5 rounded-full bg-linear-to-br from-sky-500 to-sky-700 flex items-center justify-center shrink-0">
              <Building2 className="w-2.5 h-2.5 text-white" />
            </div>
            <span className="text-[11px] font-semibold text-gray-600">Malasakit PMS</span>
          ...
          <div className="ml-7 bg-white rounded-lg border border-gray-200 px-3.5 py-2.5 shadow-sm">
            {log.body_preview
              ? <p className="text-[12px] text-gray-700 leading-relaxed whitespace-pre-line">{log.body_preview}</p>
        ...
        {log.patient_reply && (
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[11px] font-semibold text-gray-600">{log.patient_name || 'Patient'}</span>
              ...
              return (
                <div key={log.id}>
                  ...
                  <button
                    ...
                    className={`
                      w-full text-left px-4 py-3.5 border-b border-gray-50 border-l-2
                      ...
                      ${isOpen
                        ? 'bg-sky-50/60 border-l-sky-400'
                        : 'hover:bg-gray-50/60 border-l-transparent'
                      }
                    `}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        {log.subject && (
                          <p className="text-[12px] text-gray-700 font-medium truncate flex-1">
                            {log.subject}
                          </p>
                        )}
