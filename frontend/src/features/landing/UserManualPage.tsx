            ...
            <div className="w-full lg:w-3/4">
              ...
              <section id="getting-started" className="mb-16">
                <div className="mb-8 pb-4">
                  <h2 className="text-3xl font-bold text-trust-harbor font-heading mb-2">Chapter 1: Getting Started</h2>
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white rounded-2xl shadow-[0_2px_10px_rgb(0,0,0,0.04)] border border-gray-100 p-6 md:p-8">
                    ...
                    <div className="text-gray-700 font-body leading-relaxed space-y-4 mb-6">
                      ...
                      <div className="bg-blue-50 text-care-blue p-4 rounded-xl text-sm mt-4 border border-blue-100">
                        <strong>Tip:</strong> If you don't see the email within a few minutes, please check your Spam or Junk folders.
                      </div>
                    </div>
                    <div className="mt-6 w-full flex justify-center bg-gray-50 border border-gray-200 rounded-xl overflow-hidden p-2">
